function exp22d_elcs_closed_loop_integration(resumeDir)
...
if isempty(resumeDir)
    runRequiredTests();
    expRun=startExperiment('exp22d_elcs_closed_loop_integration', ...
...
root=projectRoot();
files={'docs/EXP22D_ELCS_CLOSED_LOOP_INTEGRATION_PLAN.md', ...
    ...
    'utils/exp22dElcsClosedLoopRegistry.m', ...
...
meta=struct('experiment','exp22d_elcs_closed_loop_integration', ...
...
expRun=struct('name','exp22d_elcs_closed_loop_integration', ...
