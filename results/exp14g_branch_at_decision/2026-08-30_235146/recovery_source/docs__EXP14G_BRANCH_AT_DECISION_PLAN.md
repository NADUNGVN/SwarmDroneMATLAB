...
- Both branch simulations retain the full 12 s mission horizon to preserve the
  exact time grid. Local outcomes end at the first outer control tick at or
  after 0.75 s from the decision.
