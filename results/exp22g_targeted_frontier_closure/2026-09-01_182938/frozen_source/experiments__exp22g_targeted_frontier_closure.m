function exp22g_targeted_frontier_closure(resumeDir)
...
if isempty(resumeDir)
    runRequiredTests();
    expRun=startExperiment('exp22g_targeted_frontier_closure', ...
        ['Analytically cost-targeted periodic frontier versus ELCS-F; ' ...
        'strict and epsilon dominance.']);
...
fprintf('\nEXP22G targeted-frontier integrity gates\n');
...
for c=R.cells
    ...
    for arm=R.arms(1:2)
        ...
        q=q+1;
        rmse=pairedBootstrapCI(A.RMSE,E.RMSE,10000,16048900+2*q,30);
        cost=pairedBootstrapCI(A.TOTAL_OFFERED_UTIL, ...
            E.TOTAL_OFFERED_UTIL,10000,16048901+2*q,30);
...
root=projectRoot();
files={'docs/EXP22G_TARGETED_FRONTIER_CLOSURE_PLAN.md', ...
    ...
    'utils/exp22gTargetedFrontierRegistry.m', ...
...
meta=struct('experiment','exp22g_targeted_frontier_closure', ...
...
expRun=struct('name','exp22g_targeted_frontier_closure', ...
