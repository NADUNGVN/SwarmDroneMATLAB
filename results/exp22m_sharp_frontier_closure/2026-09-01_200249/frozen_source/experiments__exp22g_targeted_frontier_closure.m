...
switch lower(char(variant))
    ...
    case 'exp22m'
        R=exp22mSharpFrontierRegistry();
        experimentName='exp22m_sharp_frontier_closure';
        studyTag='EXP22M';
        description=['Exact one-percent-cost periodic boundary ' ...
            'falsification of event-driven ELCS-F.'];
    otherwise
...
elseif strcmp(studyTag,'EXP22M')
    plan='docs/EXP22M_SHARP_FRONTIER_CLOSURE_PLAN.md';
    registry='utils/exp22mSharpFrontierRegistry.m';
    wrapper='experiments/exp22m_sharp_frontier_closure.m';
else
