...
V.terminalResolved=splitapply(@sum,T.DSTR_KERNEL_FINAL_RESOLVED,group);
V.terminalCollisionFree=splitapply( ...
    @sum,T.DSTR_KERNEL_FINAL_COLLISION_FREE,group);
V.terminalFrameAgreement=splitapply( ...
    @sum,T.DSTR_KERNEL_FINAL_FRAME_AGREEMENT,group);
