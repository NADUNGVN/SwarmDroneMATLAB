function exp23a_local_witness_kernel_falsification(resumeDir)
...
if isempty(resumeDir)
    ...
    expRun=startExperiment('exp23a_local_witness_kernel_falsification', ...
        ['One-hop conflict-witness CLAIM/CERT kernel falsification with ' ...
        'exact byte bounds and fail-silent loss boundaries.']);
...
fprintf('\nEXP23A local-witness kernel gates\n');
...
root=projectRoot();
files={'docs/EXP23_LOCAL_WITNESS_CERTIFICATE_DESIGN.md', ...
    'docs/EXP23A_LOCAL_WITNESS_KERNEL_PLAN.md', ...
    ...
    'utils/elcsWitnessTraceHash.m','utils/exp23aWitnessKernelRegistry.m', ...
...
meta=struct('experiment','exp23a_local_witness_kernel_falsification', ...
...
expRun=struct('name','exp23a_local_witness_kernel_falsification', ...
