...
while cursor<t1-tol
    ...
    if nextControl<=cursor+tol
        ...
        for index=first:last
            ...
            hasExactBytes=isfield(Q,'controlGroupBytes');
            if hasExactBytes
                S.dstrManagementBytes=S.dstrManagementBytes+ ...
                    Q.controlGroupBytes(index);
            end
            ...
            if hasExactBytes&&isfield(Q,'controlPhyRateBps')
                S.dstrManagementAirtime= ...
                    8*S.dstrManagementBytes/Q.controlPhyRateBps;
            else
