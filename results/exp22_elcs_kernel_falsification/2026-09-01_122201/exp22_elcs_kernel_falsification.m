function exp22_elcs_kernel_falsification(resumeDir)
...
if isempty(resumeDir)
    ...
    expRun=startExperiment('exp22_elcs_kernel_falsification', ...
...
root=projectRoot();
files={'docs/EXP22_EDGE_LEASE_CANDIDATE_DESIGN.md', ...
    'docs/EXP22_ELCS_KERNEL_FALSIFICATION_PLAN.md', ...
    'network/buildSenderConflictGraph.m','network/elcsAcceptGrant.m', ...
    'network/simulateElcsScheduling.m','utils/generateElcsTrace.m', ...
    'utils/elcsKernelConfig.m','utils/exp22ElcsKernelRegistry.m', ...
...
meta=struct('experiment','exp22_elcs_kernel_falsification', ...
...
expRun=struct('name','exp22_elcs_kernel_falsification', ...
