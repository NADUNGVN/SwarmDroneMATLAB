...
**Status:** v2 frozen after the retained invalid v1 run; see
`docs/EXP21D_DSTR_KERNEL_AMENDMENT_01.md` and
...
One hundred fresh v2 seeds `16034001:16034100` are used for each of
...
The executable registry requires 15 deterministic contract checks.  The run
stores a twelve-file frozen-source manifest and generates aggregate summaries
