...
checks(end+1,:)={b.shrinkRequests>0 && b.shrinkObjects>0 && ...
    b.shrinkNacks>0 && b.shrinkEvents>0, ...
...
checks(end+1,:)={~d.finalAllResolved && d.conflictFrameFraction>0 && ...
    d.dataRecipientAttempts==Cd.N-1 && d.dataRecipientCollision==0 && ...
    d.receiverTruthDecisionReads==0, ...
    'half-duplex collective collision remains an observable protocol boundary'};
