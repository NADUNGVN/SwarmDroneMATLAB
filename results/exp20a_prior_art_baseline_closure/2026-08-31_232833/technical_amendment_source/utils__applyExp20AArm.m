...
legacyId=id;
switch id
    case 'oracle-deficit-maxweight'
        legacyId='oracle-deficit-maxweight-piggyback';
    case 'oracle-urgency-maxweight'
        legacyId='oracle-urgency-maxweight-piggyback';
end
oldIds={exp19aRegistry().arms.id};
oldIndex=find(strcmp(oldIds,legacyId),1);
if ~isempty(oldIndex)
