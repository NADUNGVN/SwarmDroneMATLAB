...
[gateName,gatePassed,gateDetail] = addGate( ...
    ...
    '21 kernel + 7 policy + 8 end-to-end checks executed before matrix');
[gateName,gatePassed,gateDetail] = addGate( ...
...
r = struct( ...
    ...
    'RETRIES',NaN,'MAX_QUEUE',NaN,'MAX_HISTORY',NaN, ...
    'CHANNEL_UTIL',NaN,'OFFERED_UTIL',NaN,'DATA_AIRTIME',NaN, ...
    'ACK_AIRTIME',NaN,'ENERGY_PROXY_J',NaN,'DATA_GOODPUT_HZ',NaN, ...
