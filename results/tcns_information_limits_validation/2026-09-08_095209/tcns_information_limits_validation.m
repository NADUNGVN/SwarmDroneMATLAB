...
row = struct('linkClass',W.linkClass,'receiver',W.receiver, ...
    ...
    'initialBaseShift',W.initialBaseShift, ...
    'initialSignHalfSeparation',W.initialSignHalfSeparation, ...
    'hiddenGradientNorm',W.hiddenGradientNorm, ...
    'senderHistoryNullResidual',W.senderHistoryNullResidual, ...
    'qMinus',W.minus.expectedValue,'qPlus',W.plus.expectedValue, ...
    'actualReceiverQMinus',W.minus.candidateValue(1), ...
    'actualReceiverQPlus',W.plus.candidateValue(1), ...
    'everyCandidateSignOpposite',W.oppositeEveryCandidateValueSigns, ...
