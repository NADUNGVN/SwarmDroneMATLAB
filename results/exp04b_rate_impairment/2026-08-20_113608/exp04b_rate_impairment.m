...
expRun = startExperiment('exp04b_rate_impairment');
...
%
% One row per (seed, communication rate, packet-loss level, delay level).
% ============================================================
...
T = tidyFromArray( ...
    struct( ...
        ...
        'ARRIVAL',       ARRIVAL, ...
        'TXRATE',        TXRATE, ...
        'SAFETYFAIL',    double(SAFETYFAIL), ...
        'FORMATIONFAIL', double(FORMATIONFAIL)), ...
    {'seed','commRateHz','packetLoss','delay'}, ...
    {1:numSeeds, commRates, lossLevels, delayLevels});
