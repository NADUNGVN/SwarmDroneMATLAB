...
% Every direct decode edge is also a physical detectability edge even when
% that link is not selected as a parent edge in this multicast tree.
senderConflict=buildSenderConflictGraph(children,interference,reach);
