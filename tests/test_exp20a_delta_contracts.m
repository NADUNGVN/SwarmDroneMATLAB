...
tailCfg=struct('N',20,'rho',0.5,'epsilon',0.20, ...
    'slots',R.nativeSlots,'burnIn',R.nativeBurnIn, ...
    'feedbackLoss',R.privateFeedbackLoss, ...
    'feedbackDelaySlots',R.privateFeedbackDelaySlots);
tail=simulateDeltaInformationStructure( ...
    tailCfg,'delta-public',R.nativeSeeds(10));
checks(end+1,:)={tail.MEAN_AOII>100, ...
    'public DELTA retains the upstream hot-start/CR heavy-tail boundary'};
