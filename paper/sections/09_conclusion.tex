...
section. EXP11 adds direct within-mission evidence: all four adjacent
Causal-v3 rate changes have the expected sign without a regime label;
RMSE is lower than P10; and $C_{0.25}$ is lower than P20 at the
pre-registered ACK weight. The central contribution is adaptivity under
unknown and changing network conditions with one fixed causal policy, not
universal dominance over tuned periodic communication. P12.5 retains
...
First, \textbf{fewer DATA packets do not imply less total traffic.} Against $20$~Hz
...
Second, \textbf{the non-causal ideal-feedback policy is an
information-efficiency reference, not a bound on attainable accuracy.}
That variant transmits less
