...
and impaired ACKs both give \MetricAckImpStressedReliableRate{} Hz at the
$s_{\min}=\MetricAckImpStressedReliableScale{}$ floor; the flat response is
saturation, not robustness. By contrast, the Moderate rate changes from
\MetricAckImpModerateReliableRate{} to
\MetricAckImpModerateImpairedRate{} Hz as the scale falls from
\MetricAckImpModerateReliableScale{} to
\MetricAckImpModerateImpairedScale{}. One topology condition fails because
