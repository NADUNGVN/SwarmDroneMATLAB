...
reachable witness exists for all ten.  The maximum is 0.232, or 0.145 and
0.175 under RMS and IQR/1.349 scaling; the two smallest remain order
\(10^{-4}\).  Figure~\ref{fig:witness} shows this heterogeneity.
