...
| B4: ACK economics is not actual global-statistic acquisition | Yes | The existing experiment can only support a cost-sensitivity screen. | Figure 4, Table V, abstract, contribution C4, and Sec. VIII-D now use “ACK-like” and explicitly deny protocol acquisition-cost measurement. |
