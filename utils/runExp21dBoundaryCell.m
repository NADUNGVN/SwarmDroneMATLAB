...
row.SCHEDULE_TERMINAL_RESOLVED=double(arm.warm || K.finalAllResolved);
row.SCHEDULE_TERMINAL_COLLISION_FREE=double( ...
    arm.warm || K.finalCollisionFree);
row.SCHEDULE_TERMINAL_FRAME_AGREEMENT=double( ...
    arm.warm || K.finalFrameAgreement);
