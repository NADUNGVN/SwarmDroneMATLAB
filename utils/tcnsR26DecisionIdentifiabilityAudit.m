...
for k = 1:height(registry)
    ...
    for s = reshape(senders,1,[])
        ...
        row.rankGap = decision.rankGap;
        row.hasCommonHiddenOffset = decision.hasCommonHiddenOffset;
        row.commonHiddenOffsetResidual = ...
            decision.commonHiddenOffsetResidual;
...
row = struct('sourceR2Run',"",'configurationId',"",'N',NaN, ...
    ...
    'rValue',NaN,'rRelative',NaN,'rankGap',NaN, ...
    'hasCommonHiddenOffset',false,'commonHiddenOffsetResidual',NaN, ...
