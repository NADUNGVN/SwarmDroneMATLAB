...
R.experimentName='exp23aj_routed_management_diagnostic';
R.testScript='test_exp23aj_routed_management_contracts';
R.planFile='docs/EXP23AJ_ROUTED_MANAGEMENT_DIAGNOSTIC_PLAN.md';
R.registryFile='utils/exp23ajRoutedManagementRegistry.m';
R.testFile='tests/test_exp23aj_routed_management_contracts.m';
R.entryFile='experiments/exp23aj_routed_management_diagnostic.m';
R.validStatus='ROUTED_MANAGEMENT_PRIMITIVE_DIAGNOSTIC_VALID';
R.invalidStatus='ROUTED_MANAGEMENT_PRIMITIVE_DIAGNOSTIC_INVALID';
