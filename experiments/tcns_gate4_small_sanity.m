...
nexttile;
plot(ca.cost025PerChannel_Hz,ca.formationRMSE_m,'o-', ...
    'Color',[0.10 0.38 0.70],'LineWidth',1.3,'MarkerFaceColor',[0.10 0.38 0.70]);
hold on;
scatter(tidy.cost025PerChannel_Hz(1:2),tidy.formationRMSE_m(1:2),70, ...
    [0.25 0.25 0.25;0.80 0.25 0.12],'filled');
xlabel('DATA + 0.25 ACK [Hz/channel]');
ylabel('formation RMSE [m]');
legend({'control-aware sweep','P10','Causal-v3'},'Location','best');
grid on;
