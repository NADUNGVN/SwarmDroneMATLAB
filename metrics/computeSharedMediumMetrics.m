...
managementAirtime=0;
if isfield(out,'serviceScheduler') && ...
        isfield(out.serviceScheduler,'dstrManagementAirtime')
    managementAirtime=out.serviceScheduler.dstrManagementAirtime;
end
...
M.offeredAirtimeUtilization = ...
    (s.dataAirtime+s.ackAirtime+managementAirtime)/T;
M.dataAirtime = s.dataAirtime;
M.ackAirtime = s.ackAirtime;
M.managementAirtime = managementAirtime;
...
M.energyProxyJ = cfg.mac.txPowerW* ...
    (s.dataAirtime+s.ackAirtime+managementAirtime);
